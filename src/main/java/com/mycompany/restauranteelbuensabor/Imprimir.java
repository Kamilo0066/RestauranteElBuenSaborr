...
public class Imprimir {
        ...
        while (indice < Datos.nombresProductos.length) {
            if (Datos.cantidadesProductos[indice] > 0) {
                System.out.printf("%-20s x%-6d $%,.0f%n",
                    Datos.nombresProductos[indice],
                    Datos.cantidadesProductos[indice],
                    (Datos.preciosProductos[indice] * Datos.cantidadesProductos[indice]));
    ...
    public static void imprimirFacturaCompleta() {
        ...
        int j = 0;
        while (j < Datos.nombresProductos.length) {
            if (Datos.cantidadesProductos[j] > 0) {
                System.out.printf("%-20s x%-6d $%,.0f%n",
                    Datos.nombresProductos[j],
                    Datos.cantidadesProductos[j],
                    (Datos.preciosProductos[j] * Datos.cantidadesProductos[j]));
            }
            j++;
        }
